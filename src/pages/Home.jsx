...
export default function Home() {
  const { items = [] } = useStock() // Inicialize items como um array vazio se undefined
  ...
  const recentItems = items.filter((item) => new Date(item.createdAt) >= limitDate && new Date(item.createdAt) <= today)
