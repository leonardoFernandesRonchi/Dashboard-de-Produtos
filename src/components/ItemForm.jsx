...
export default function ItemForm({ itemToUpdate }) {
  ...
  const { addItem, updateItem } = useStock(); // Certifique-se de que addItem e updateItem são importados corretamente do contexto
  ...
  const handleSubmit = (ev) => {
    ...
    try {
      if (itemToUpdate) {
        ...
        console.log("Adding new item:", validItem);
        addItem(validItem);
        setItem(defaultItem);
